...
set(CULT_ASAN_BLACK_LIST "" CACHE FILEPATH "black list file that must be provided to asan")
...
MACRO(debug_compile_options target)
    if(CMAKE_BUILD_TYPE STREQUAL "Debug")
		...
		if (NOT CULT_ASAN_BLACK_LIST MATCHES "")
			message("using asan black list")
			TARGET_COMPILE_OPTIONS(${target} PRIVATE -fsanitize-blacklist=CULT_ASAN_BLACK_LIST)
		endif()
        if (CULT_ASAN)
